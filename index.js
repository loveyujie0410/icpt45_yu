...
const UUID = process.env.UUID || 'd5214526-a225-547f-a92d-8171577a0083'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'zero.icpt.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiY2M5MWJkOWVkZWE5ZmM2NGIxYjQ5MGQzZWJmZDA4Y2YiLCJ0IjoiNzVkNWMxMzctMjAyNS00NmI1LTk5YTMtYTMzMDdhNGMzNmFkIiwicyI6Ik4yTTRZbUUzWWpZdFltRXlNaTAwTldNeExUbG1ZVGd0TkRZNFpEUm1NR05qWWpNeiJ9
...
const NAME = process.env.NAME || 'icpt';                        // 节点名称
